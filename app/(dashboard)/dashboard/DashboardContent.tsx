                ...
                <>
                  ...
                  <div style={{
                    ...
                    <Link
                      href="/analytics"
                      onClick={() => setMenuOpen(false)}
                      style={{ display: "flex", alignItems: "center", gap: "10px", padding: "10px 12px", color: "#d1d5db", textDecoration: "none", fontSize: "14px", borderRadius: "8px" }}
                    >
                      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                    ...
                    <button
                      ...
                      style={{ display: "flex", alignItems: "center", gap: "10px", padding: "10px 12px", color: "#f87171", background: "none", border: "none", fontSize: "14px", borderRadius: "8px", cursor: "pointer", width: "100%", textAlign: "left" }}
                    >
                      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
      ...
      <main style={{ maxWidth: "900px", margin: "0 auto", padding: "32px 24px" }}>
        ...
        <div style={cardStyle}>
          ...
          <p style={{ color: "#9ca3af", fontSize: "14px", marginBottom: "20px" }}>
            ...
            <br />TikTok and Instagram API will be coming soon.
          </p>
